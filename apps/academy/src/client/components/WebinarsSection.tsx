// apps/academy/components/news/WebinarsSection.tsx
...
const cardColors = ["#88C0E0", "#78A1E1", "#5B7DB1", "#A685C6", "#C49ED7"];
...
const WebinarsSection = () => {
  ...
  const webinarEvents = events.filter((event) => event.type === "Webinar");
